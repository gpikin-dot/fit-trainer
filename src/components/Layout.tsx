        ...
        >
          ...
          >
            <div className="relative w-10 h-10 shrink-0">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-[10px] font-bold text-[var(--slate-900)]">
                {fmt(timerSec)}
              </div>
            </div>
            <div className="text-left">
              <div className="text-[10px] text-[var(--slate-400)] uppercase tracking-wider">отдых</div>
              {timerNextEx && (
          ...
          <div className="flex border-t border-[var(--slate-100)]">
            ...
            <button
              onClick={() => addTime(30)}
              className="flex-1 py-2 flex items-center justify-center gap-1 text-[10px] text-[var(--slate-500)] hover:bg-[var(--slate-50)] border-l border-[var(--slate-100)]"
            >
