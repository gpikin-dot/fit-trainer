  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] flex items-center justify-center px-4">
      <div className="max-w-[390px] w-full">
        <Link
          to="/login"
          className="text-[var(--fs-2xs)] font-semibold text-[var(--indigo-500)] flex items-center gap-1 mb-3"
        >
          ← Назад
        </Link>

        <div className="bg-white rounded-[16px] px-[17px] py-[22px] border border-[var(--border)]">
          <h1 className="text-[1rem] font-bold text-[var(--slate-900)] mb-[2px]">Регистрация тренера</h1>
          <p className="text-[var(--fs-2xs)] text-[var(--slate-400)] mb-4">Создайте аккаунт, чтобы приглашать клиентов</p>
